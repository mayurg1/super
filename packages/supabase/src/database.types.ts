  ...
  public: {
    Tables: {
      ...
      campaign_activity: {
        ...
        Relationships: [
          {
            foreignKeyName: "campaign_activity_actor_id_fkey"
            columns: ["actor_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      job_application_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "job_application_events_actor_id_fkey"
            columns: ["actor_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      profile_activities: {
        ...
        Relationships: [
          {
            foreignKeyName: "profile_activities_actor_id_fkey"
            columns: ["actor_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      project_files: {
        ...
        Relationships: [
          {
            foreignKeyName: "project_files_media_asset_id_fkey"
            columns: ["media_asset_id"]
            isOneToOne: false
            referencedRelation: "media_assets"
            referencedColumns: ["id"]
      ...
      role_requests: {
        Row: {
          ...
          supporting_document_asset_id: string | null
          updated_at: string
          user_id: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "role_requests_campus_id_fkey"
            columns: ["campus_id"]
            isOneToOne: false
            referencedRelation: "campuses"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "role_requests_supporting_document_asset_id_fkey"
            columns: ["supporting_document_asset_id"]
            isOneToOne: false
            referencedRelation: "media_assets"
            referencedColumns: ["id"]
          },
